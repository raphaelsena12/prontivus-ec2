...
export function ProcedimentosTable({
  ...
  const columns: ColumnDef<Procedimento>[] = React.useMemo(
    () => [
      {
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <Badge 
            variant="outline" 
            className={`bg-transparent text-[10px] py-0.5 px-1.5 leading-tight ${
              row.original.ativo 
    ...
    <div className="flex flex-col gap-4 overflow-auto">
      <div className="overflow-hidden px-6 pt-6">
        ...
        <div className="text-muted-foreground hidden flex-1 text-xs lg:flex">
          {table.getFilteredRowModel().rows.length} procedimento(s) encontrado(s).
        </div>
