...
interface EditarMovimentacaoFormProps {
  movimentacao: any;
  clinicaId: string;
  formasPagamento: Array<{ id: string; nome: string }>;
}

export function EditarMovimentacaoForm({ movimentacao, clinicaId, formasPagamento }: EditarMovimentacaoFormProps) {
      ...
      <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Edite as informações da movimentação</p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Atualize as informações da movimentação</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
