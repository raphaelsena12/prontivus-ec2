  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(getApiErrorMessage(error) || "Erro ao excluir médico");
      }
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            <strong className="text-foreground">{medico?.usuario.nome}</strong>?
            <br />
            <br />
            Esta ação irá remover permanentemente o médico do sistema.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
