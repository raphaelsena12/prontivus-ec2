...
import { Search, ExternalLink, History, Filter } from "lucide-react";
...
export function HistoricoAtendimentosContent() {
  ...
  const handleViewHistorico = (pacienteId: string) => {
        ...
        cell: ({ row }) => (
          <div className="flex justify-end gap-2">
            <Button
              variant="outline"
              size="sm"
              onClick={() => handleViewHistorico(row.original.id)}
              title="Ver Histórico"
  ...
  return (
    <div className="@container/main flex flex-1 flex-col px-4 lg:px-6 py-6">
      <PageHeader
        ...
        subtitle="Consulte o histórico de consultas e exames dos pacientes"
      />
      ...
      <Card className="bg-white border shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between pb-1 border-b px-6 pt-1.5">
          ...
          <div className="relative max-w-md">
            ...
            <Input
              type="search"
              placeholder="Buscar por nome, CPF ou nº prontuário..."
              value={globalFilter}
