...
const documentModels: DocumentModel[] = [
  { id: "prontuario-medico", nome: "Prontuario Medico", descricao: "Prontuario completo com anamnese, exame fisico, diagnostico e conduta", categoria: "prontuario", icon: FileText },
  { id: "receita-medica", nome: "Receita Medica", descricao: "Receita medica simples com prescricoes do atendimento", categoria: "receitas", icon: Pill },
  ...
  { id: "receita-tipo-ba", nome: "Receita Tipo B/A", descricao: "Receita especial para substancias tipo B e A", categoria: "receitas", icon: ShieldCheck },
  { id: "atestado-afastamento", nome: "Atestado de Afastamento", descricao: "Atestado medico para afastamento do trabalho ou atividades", categoria: "atestados", icon: FileCheck, needsForm: true },
  { id: "atestado-afastamento-cid", nome: "Atestado de Afastamento c/ CID", descricao: "Atestado de afastamento incluindo codigo CID-10 do diagnostico", categoria: "atestados", icon: FileCheck, needsForm: true },
  { id: "atestado-afastamento-sem-cid", nome: "Atestado de Afastamento s/ CID", descricao: "Atestado de afastamento sem exposicao do codigo CID-10", categoria: "atestados", icon: FileCheck, needsForm: true },
  { id: "atestado-afastamento-historico-cid", nome: "Atestado de Afastamento com Historico de CID", descricao: "Atestado com historico completo de CIDs relacionados ao afastamento", categoria: "atestados", icon: FileCheck, needsForm: true },
  ...
  { id: "atestado-aptidao-fisica-mental", nome: "Atestado de Aptidao Fisica e Mental", descricao: "Atestado comprovando aptidao fisica e mental para atividades", categoria: "atestados", icon: UserCheck },
  { id: "atestado-aptidao-piscinas", nome: "Atestado de Aptidao para Frequentar Piscinas", descricao: "Atestado comprovando condicoes de saude para uso de piscinas", categoria: "atestados", icon: Droplet },
  { id: "atestado-aptidao-fisica", nome: "Atestado de Aptidao Fisica", descricao: "Atestado comprovando aptidao fisica para atividades esportivas", categoria: "atestados", icon: Activity },
  { id: "declaracao-comparecimento-acompanhante", nome: "Declaracao de Comparecimento (Acompanhante)", descricao: "Declaracao para acompanhantes que necessitam comprovar presenca", categoria: "atestados", icon: UserCheck },
  { id: "declaracao-comparecimento-horario-cid", nome: "Declaracao de Comparecimento de Horario c/ CID", descricao: "Declaracao com horario de atendimento e codigo CID-10", categoria: "atestados", icon: UserCheck },
  { id: "declaracao-comparecimento", nome: "Declaracao de Comparecimento", descricao: "Declaracao simples de comparecimento a consulta medica", categoria: "atestados", icon: UserCheck },
  { id: "pedido-exames", nome: "Pedido de Exames", descricao: "Solicitacao de exames laboratoriais e de imagem", categoria: "exames", icon: FlaskConical },
  { id: "justificativa-exames-plano", nome: "Justificativa de Exames para Planos de Saude", descricao: "Justificativa medica para autorizacao de exames pelo plano de saude", categoria: "exames", icon: ClipboardList },
  { id: "laudo-medico", nome: "Laudo Medico", descricao: "Laudo medico detalhado com diagnostico e parecer tecnico", categoria: "laudos", icon: ScrollText },
  { id: "risco-cirurgico-cardiaco", nome: "Risco Cirurgico Cardiaco", descricao: "Avaliacao de risco cirurgico cardiaco pre-operatorio", categoria: "laudos", icon: Heart },
  { id: "guia-encaminhamento", nome: "Guia de Encaminhamento", descricao: "Guia para encaminhamento a outro especialista ou servico", categoria: "laudos", icon: Stethoscope },
  { id: "controle-diabetes-analitico", nome: "Controle de Diabetes Analitico", descricao: "Ficha analitica de acompanhamento de diabetes com graficos e metricas", categoria: "outros", icon: Activity },
  ...
  { id: "controle-pressao-arterial-analitico", nome: "Controle de Pressao Arterial Analitico", descricao: "Ficha analitica de acompanhamento de pressao arterial com metricas", categoria: "outros", icon: Heart },
  { id: "controle-pressao-arterial", nome: "Controle de Pressao Arterial", descricao: "Ficha de controle e acompanhamento de pressao arterial", categoria: "outros", icon: Heart },
...
export function DocumentModelsSheet({
  ...
  const categoryLabels: Record<string, string> = {
    ...
    receitas: "Receitas",
    atestados: "Atestados & Declaracoes",
    exames: "Exames",
